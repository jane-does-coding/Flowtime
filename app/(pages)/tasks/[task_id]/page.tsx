	...
	return (
		<>
			...
			<div className="w-[90vw] min-h-screen md:w-[60vw] mx-auto  py-4 flex flex-col gap-4 items-center justify-center mt-28 pb-28 xl:m-y-0">
				<h1 className="text-[3.25rem] font-bold text-black ">{task.title}</h1>
				<p className="text-neutral-600 text-xl">{task.description}</p>
				...
				<div className="w-full py-8 flex flex-col items-start justify-center gap-4 my-2 border-y-[1px] border-neutral-600">
					...
					<span className="text-[1.25rem] xl:text-[1.5rem] w-full flex items-center justify-start gap-2 bg-red-300/75 text-black jura px-10 py-2 rounded-full">
